public class day5 {
    public static void main(String args[]) {
        ...
        int resultPart1 = 0;
        for (int l = 0; l < diagram.length; l++) {
            for (int m = 0; m < diagram[l].length; m++) {
                if (diagram[l][m] > 1) {
                    resultPart1++;
                }
            }
        ...
        for (int i = 0; i < input.length; i++) {
            ...
            // y1 = y2: horizontal line
                ...
                if (x1 == xLow && y1 == yLow) { // right-bottom diagonal
                    for (int a = xLow; a <= xHigh; a++) {
                        diagram[a][yLow]++;
                        yLow++;
                    }
                } else if (x2 == xLow && y1 == yLow) { // left-bottom diagonal
                    for (int b = xHigh; b >= xLow; b--) {
                        diagram[b][yLow]++;
                        yLow++;
                    }
                } else if (x2 == xLow && y2 == yLow) { // left-top diagonal
                    for (int c = xHigh; c >= xLow; c--) {
                        diagram[c][yHigh]++;
                        yHigh--;
                    }
                } else if (x1 == xLow && y2 == yLow) { // right-top diagonal
                    for (int d = xLow; d <= xHigh; d++) {
                        diagram[d][yHigh]++;
                        yHigh--;
                    }
                } else {
